...
class AppColors {
  ...
  static const titleLight = Color.fromARGB(255, 113, 118, 255);
  // static const titleLight = Color(0xFF272B30);
  static const textLight = Color(0xFF6F767E);
  static const textGrey = Color.fromARGB(221, 33, 33, 33);
  ...
  static const starClr = Color.fromARGB(255, 168, 168, 173);

  static const primary = Color.fromARGB(255, 46, 82, 244);
