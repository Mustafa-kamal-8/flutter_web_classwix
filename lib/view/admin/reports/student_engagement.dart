...
class StudentEngagementScreen extends StatefulWidget {
  const StudentEngagementScreen({super.key});

  @override
  State<StudentEngagementScreen> createState() =>
      StudentEngagementScreenState();
}

class StudentEngagementScreenState extends State<StudentEngagementScreen> {
  bool _isHover = false;
  @override
  void initState() {
    getUserInfo();
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: "Student Engagement Report  ",
                        style:
                            Theme.of(context).textTheme.headlineLarge!.copyWith(
                                  // fontWeight: FontWeight.w600,
                                  fontSize: 16,
