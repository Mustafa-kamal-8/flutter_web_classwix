...
class InstructorEngagementScreen extends StatefulWidget {
  const InstructorEngagementScreen({super.key});

  @override
  State<InstructorEngagementScreen> createState() =>
      InstructorEngagementScreenState();
}

class InstructorEngagementScreenState
    extends State<InstructorEngagementScreen> {
  bool _isHover = false;
  @override
  void initState() {
    getUserInfo();
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: "Instructor Engagement Report  ",
                        style:
                            Theme.of(context).textTheme.headlineLarge!.copyWith(
                                  // fontWeight: FontWeight.w600,
                                  fontSize: 16,
                  ...
                  TextButton.icon(
                    ...
                    style: ButtonStyle(
                        backgroundColor: WidgetStatePropertyAll(
                            _isHover ? AppColors.primary : Colors.white),
                    ...
                    icon: Icon(
                      Icons.download,
                      size: 15,
                      color: _isHover ? Colors.white : AppColors.primary,
                    ),
                  ),
                  gapW(15)
                ],
