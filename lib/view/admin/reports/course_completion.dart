...
class CourseCompletionScreen extends StatefulWidget {
  ...
  @override
  State<CourseCompletionScreen> createState() => CourseCompletionScreenState();
}

class CourseCompletionScreenState extends State<CourseCompletionScreen> {
  bool _isHover = false;
  @override
  void initState() {
    getUserInfo();
