...
class FeaturedCourseListScreen extends StatefulWidget {
  ...
  @override
  State<FeaturedCourseListScreen> createState() =>
      FeaturedCourseListScreenState();
}

class FeaturedCourseListScreenState extends State<FeaturedCourseListScreen> {
  bool _isHover = false;
  @override
  void initState() {
    getUserInfo();
