...
class FooterMenuScreen extends StatefulWidget {
  const FooterMenuScreen({super.key});

  @override
  State<FooterMenuScreen> createState() => FooterMenuScreenState();
}

class FooterMenuScreenState extends State<FooterMenuScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
