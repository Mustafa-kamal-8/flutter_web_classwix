...
class SuspendedInstructorsScreen extends StatefulWidget {
  const SuspendedInstructorsScreen({super.key});

  @override
  State<SuspendedInstructorsScreen> createState() =>
      _SuspendedInstructorsScreenState();
}

class _SuspendedInstructorsScreenState
    extends State<SuspendedInstructorsScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: "Instructor Suspended Lists  ",
                        style:
                            Theme.of(context).textTheme.headlineLarge!.copyWith(
                                  // fontWeight: FontWeight.w600,
                                  fontSize: 16,
