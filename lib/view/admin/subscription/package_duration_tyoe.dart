...
class PackageDurationTypeScreen extends StatefulWidget {
  const PackageDurationTypeScreen({super.key});

  @override
  State<PackageDurationTypeScreen> createState() =>
      PackageDurationTypeScreenState();
}

class PackageDurationTypeScreenState extends State<PackageDurationTypeScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
