...
class RejectedCourseScreen extends StatefulWidget {
  ...
  @override
  State<RejectedCourseScreen> createState() => RejectedCourseScreenState();
}

class RejectedCourseScreenState extends State<RejectedCourseScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
