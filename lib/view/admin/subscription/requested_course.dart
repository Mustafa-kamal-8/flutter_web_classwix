...
class RequestedCourseScreen extends StatefulWidget {
  const RequestedCourseScreen({super.key});

  @override
  State<RequestedCourseScreen> createState() => RequestedCourseScreenState();
}

class RequestedCourseScreenState extends State<RequestedCourseScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
