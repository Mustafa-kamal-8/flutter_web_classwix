...
class PackagePurchaseListScreen extends StatefulWidget {
  const PackagePurchaseListScreen({super.key});

  @override
  State<PackagePurchaseListScreen> createState() =>
      PackagePurchaseListScreenState();
}

class PackagePurchaseListScreenState extends State<PackagePurchaseListScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
