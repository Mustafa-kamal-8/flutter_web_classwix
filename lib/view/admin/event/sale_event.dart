...
class SaleEventScreen extends StatefulWidget {
  const SaleEventScreen({super.key});

  @override
  State<SaleEventScreen> createState() => SaleEventScreenState();
}

class SaleEventScreenState extends State<SaleEventScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
