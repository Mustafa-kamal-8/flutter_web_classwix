...
class RejectedEventsScreen extends StatefulWidget {
  const RejectedEventsScreen({super.key});

  @override
  State<RejectedEventsScreen> createState() => RejectedEventsScreenState();
}

class RejectedEventsScreenState extends State<RejectedEventsScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
