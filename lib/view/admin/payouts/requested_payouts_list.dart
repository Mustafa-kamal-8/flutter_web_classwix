...
class RequestedPayoutsListScreen extends StatefulWidget {
  const RequestedPayoutsListScreen({super.key});

  @override
  State<RequestedPayoutsListScreen> createState() =>
      _RequestedPayoutsListScreenState();
}

class _RequestedPayoutsListScreenState
    extends State<RequestedPayoutsListScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
