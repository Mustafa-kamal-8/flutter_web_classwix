...
class RejectedPayoutsListScreen extends StatefulWidget {
  const RejectedPayoutsListScreen({super.key});

  @override
  State<RejectedPayoutsListScreen> createState() =>
      _RejectedPayoutsListScreenState();
}

class _RejectedPayoutsListScreenState extends State<RejectedPayoutsListScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
