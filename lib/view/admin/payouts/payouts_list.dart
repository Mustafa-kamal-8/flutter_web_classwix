...
class PayoutsListScreen extends StatefulWidget {
  const PayoutsListScreen({super.key});

  @override
  State<PayoutsListScreen> createState() => _PayoutsListScreenState();
}

class _PayoutsListScreenState extends State<PayoutsListScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
