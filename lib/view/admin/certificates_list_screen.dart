...
class CertificatesListSccreen extends StatefulWidget {
  const CertificatesListSccreen({super.key});

  @override
  State<CertificatesListSccreen> createState() =>
      _CertificatesListSccreenState();
}

class _CertificatesListSccreenState extends State<CertificatesListSccreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
