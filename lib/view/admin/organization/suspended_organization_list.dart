...
class SuspendedOrganizationListScreen extends StatefulWidget {
  const SuspendedOrganizationListScreen({super.key});

  @override
  State<SuspendedOrganizationListScreen> createState() =>
      _SuspendedOrganizationListScreenState();
}

class _SuspendedOrganizationListScreenState
    extends State<SuspendedOrganizationListScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: "Organization Suspended List  ",
                        style:
                            Theme.of(context).textTheme.headlineLarge!.copyWith(
                                  // fontWeight: FontWeight.w600,
                                  fontSize: 14,
