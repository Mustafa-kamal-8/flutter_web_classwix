...
class RequestedOrganizationScreen extends StatefulWidget {
  ...
  @override
  State<RequestedOrganizationScreen> createState() =>
      _RequestedOrganizationScreenState();
}

class _RequestedOrganizationScreenState
    extends State<RequestedOrganizationScreen> {
  @override
  void initState() {
    getUserInfo();
    super.initState();
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: "Organization Request List  ",
                        style:
                            Theme.of(context).textTheme.headlineLarge!.copyWith(
                                  // fontWeight: FontWeight.w600,
                                  fontSize: 14,
